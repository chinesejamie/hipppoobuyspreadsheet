      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#3B82F6]/10 rounded-full mb-4">
            ...
            <span className="text-[#3B82F6] font-semibold text-sm">Why Choose HipoBuy</span>
          </div>
          ...
          <p className="text-gray-600 text-base sm:text-lg max-w-3xl mx-auto">
            We make international shopping simple, safe, and affordable. Discover why thousands choose HipoBuy for their Chinese marketplace purchases.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-white rounded-2xl p-6 shadow-md border border-gray-200 hover:shadow-xl hover:border-[#3B82F6]/30 transition-all duration-300 hover:-translate-y-1"
            >
              {/* Icon */}
        ...
        {/* Stats Bar */}
        <div className="mt-12 bg-gradient-to-r from-[#3B82F6] via-red-700 to-blue-500 rounded-2xl p-8 sm:p-10 shadow-2xl">
